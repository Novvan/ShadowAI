...
namespace DeliverableIA.Imported_Assets.StarterAssets.ThirdPersonController.Scripts
{
	...
	public class ThirdPersonController : MonoBehaviour
	{
		...
		[Tooltip("Enable on move rotation")]
		...
		[Tooltip("Camera sensitivity when moving the camera")]
		...
		public void SetRotateOnMove(bool enable)
		{
			_rotateOnMove = enable;
		}
	}
}
