...
namespace DeliverableIA.Imported_Assets.StarterAssets.Editor
{
    ...
    public partial class StarterAssetsDeployMenu : ScriptableObject
    {
        ...
        {
            ScriptingDefineUtils.RemoveScriptingDefine(PackageChecker.PackageChecker.PackageCheckerScriptingDefine);
        }
